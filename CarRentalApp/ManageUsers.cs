    ...
    public partial class ManageUsers : Form
    {
        ...
        private void btnResetPassword_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show($"{user.user}'s password has been reset!");
            }
            catch (Exception ex)
            {
        ...
        private void btnDeactivateUser_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show($"{user.user} active status has changed.");
                PopulateGrid();
            }
            catch (Exception ex)
            {
        ...
        {
            var cars = _db.Users.Select(q => new
            {
                q.id,
                q.user,
            ...
            gvUserList.Columns["user"].HeaderText = "Username";
